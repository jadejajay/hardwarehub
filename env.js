 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.mainapp.staging
 */

const BUNDLE_ID = 'com.mainapp'; // ios bundle id
const PACKAGE = 'com.mainapp'; // android package name
const NAME = 'mainapp'; // app name
